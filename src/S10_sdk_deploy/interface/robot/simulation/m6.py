"""
S10 MuJoCo ROS2 simulation with optimized autonomous
...
# MuJoCo body representing the S10 base
...
RENDER_INTERVAL = 20          # 25 Hz
STATE_PUBLISH_INTERVAL = 10   # 50 Hz
NAVIGATION_INTERVAL = 5       # 100 Hz
...
MAX_BASE_DOWN_SPEED = 0.25
MAX_BASE_UP_SPEED = 0.80
...
# ============================================================
# UPDATED:
# Waypoint is now considered reached within 0.20 m.
# ============================================================
...
def parse_cli_args():
    ...
    parser = argparse.ArgumentParser(
        description="Optimized S10 MuJoCo ROS2 simulation"
    )
...
class MuJoCoSimulationNode(Node):
    ...
    def __init__(
        ...
        self.get_logger().info(
            "[INFO] Optimized simulation initialized."
        )
        ...
        self.get_logger().info(
            f"[NAVIGATION] Max speed = "
            f"{MAX_FORWARD_SPEED:.2f} m/s"
        )

        self.get_logger().info(
            f"[NAVIGATION] Waypoint reach radius = "
    ...
    def _navigation_controller(self):
        ...
        if (
            ...
            # ------------------------------------------------
            # UPDATED APPROACH SLOWDOWN
            #
            # Robot progressively slows as it approaches
    ...
    def _waypoint_reached(self):
        ...
        self.get_logger().info(
            ...
            f"| tolerance={TRACK_REACH_RADIUS:.2f} m"
        )
    ...
    def _send_navigation_command(
        ...
        max_up = (
            MAX_BASE_UP_SPEED * DT
        )

        max_down = (
            MAX_BASE_DOWN_SPEED * DT
        )
    ...
    def start(self):
        ...
        self.get_logger().info(
            "[INFO] Starting optimized simulation loop."
        )
