...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--z-offset", type=float, default=0.05, help="Height added to clicked surface points.")
    parser.add_argument("--marker-radius", type=float, default=0.42)
    parser.add_argument("--line-radius", type=float, default=0.14)
    parser.add_argument("--post-radius", type=float, default=0.045)
